...
const HomePostBlock = ({ PostDetails }) => {
  ...
  return (
    <>
      {/* <i
        ...
        ></i> */}
      {liked ? (
        <i id="lik2" className="fa fa-heart" onClick={() => changeLike()}></i>
      ) : (
        <i id="lik1" className="far fa-heart" onClick={() => changeLike()}></i>
      )}
    </>
  );
};
        ...
        PostDetails={[
          {
            ...
            postImg: hp1,
            caption: 'Verified It s a wrap! The journey of MAFIA was amazing.',
            tag: ['karthicknaren_M.', 'priyabhavanishankar', 'prasanna_actor '],
