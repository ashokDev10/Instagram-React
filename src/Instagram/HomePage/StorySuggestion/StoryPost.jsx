...
const StoryProfile = ({ image, userName, time }) => {
  return (
  ...
  return (
    <div className="story-post">
      ...
      <div className="story-scroll">
        ...
        <StoryProfile image={si2} userName="googleindia" time="2 minutes ago" />

        <StoryProfile image={si3} userName="beargrylls" time="20 hours ago" />
        <StoryProfile image={si4} userName="hackaday" time="3 hour ago" />
        <StoryProfile image={si5} userName="gadgetstricks" time="13 hour ago" />
        ...
        <StoryProfile
          ...
          time="14 hour ago"
        />
        <StoryProfile image={si9} userName="teamthrme5" time="41 minutes ago" />
        <StoryProfile
          image={si10}
          userName="7.7.7.7_hacker"
          time="8 hour ago"
        />
        <StoryProfile image={si11} userName="tedx_official" time="9 hour ago" />
        <StoryProfile
          image={si12}
